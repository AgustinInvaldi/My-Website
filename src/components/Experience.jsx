    ...
    const jobs = [
        {
            ...
            desc: "Plataforma sanatorial, chatbot IA, módulos de diagnóstico, internaciones, turnos, facturación, kinesiología y herramientas inteligentes.",
        },
        {
            title: "Fullstack Developer - ImaJine Studio",
            date: "2021 - 2022",
            desc: "App comercial, e-commerce, paneles administrativos, encuestas, Vue, Laravel, campañas políticas.",
        },
        {
            title: "Integraciones Freelance",
            date: "2020 - 2021",
            desc: "Integración Mercado Pago, AFIP, módulos administrativos.",
        },
    ];
